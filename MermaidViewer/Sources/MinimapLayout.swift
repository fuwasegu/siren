...
public struct MinimapLayout: Equatable {
    public let minimapWidth: Double
    public let minimapHeight: Double
    public let diagramWidth: Double
    public let diagramHeight: Double
    public let padding: Double

    public init(minimapWidth: Double = 160, minimapHeight: Double = 100,
    ...
    public var minimapScale: Double {
    ...
    public var contentWidth: Double { diagramWidth + padding * 2 }
    public var contentHeight: Double { diagramHeight + padding * 2 }

    /// Thumbnail size in minimap pixels.
    public var thumbnailWidth: Double { contentWidth * minimapScale }
    public var thumbnailHeight: Double { contentHeight * minimapScale }

    /// Thumbnail offset to center it in the minimap.
    public var thumbnailOriginX: Double { (minimapWidth - thumbnailWidth) / 2 }
    public var thumbnailOriginY: Double { (minimapHeight - thumbnailHeight) / 2 }

    /// Diagram rect within the minimap (inside the padding area of the thumbnail).
    public var diagramRectX: Double { thumbnailOriginX + padding * minimapScale }
    public var diagramRectY: Double { thumbnailOriginY + padding * minimapScale }
    public var diagramRectWidth: Double { diagramWidth * minimapScale }
    public var diagramRectHeight: Double { diagramHeight * minimapScale }
