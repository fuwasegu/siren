...
public enum GridLayout {
    ...
    public static func adaptiveGridSize(baseGrid: Double = 20, scale: Double) -> Double {
    ...
    public static func dotSize(scale: Double) -> Double {
        max(0.8, scale * 0.8)
    }

    /// Dot opacity (0...0.35), increasing with grid spacing.
    public static func dotAlpha(gridSize: Double) -> Double {
    ...
    public static func gridOffset(translate: Double, gridSize: Double) -> Double {
